...
function todis() {
    $.ajax({
        ...
        data: {
            key: 'UMDBZ-3ZMKC-J4S2A-AYHQH-5QMWZ-U4FL6',
            output: 'jsonp',
        },
        dataType: 'jsonp',
        success: function(res) {
            ...
            function showWelcome() {
                ...
                // 经纬度
                let dist = getDistance(115.62992, 32.64270, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
                ...
                document.getElementsByClassName("announcement_content")[0].innerHTML =
                    `欢迎来自<span class="gonggao_adress">${pos}</span>的小伙伴，<span class="gonggao_adress">${timeChange}</span><br>
        你距离kilito约有<span class="gonggao_adress">${dist}</span>公里，${posdesc}
        <br>
        <span class="gonggao_adress">kilitoの留言:</span><br>
        欢迎光临!如有使用问题请联系我,谢谢。
        `;
            }
            showWelcome()
